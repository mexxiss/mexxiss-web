        ...
        <div className="container mx-auto">
            ...
            <div className="w-full md:w-1/2">
              <div>
                ...
                <div className="flex items-center gap-4 mt-5">
                  <Link to="https://hosting.mexxiss.com/" target="blank" className="py-2 px-3 lg:px-8 uppercase bg-primary border border-primary rounded text-white">
                    Preview
                  </Link>
          ...
          <div className="mt-10">
            ...
            <div className="mt-6">
              ...
              <img src={img} className="w-auto max-h-80 md:float-right py-5 md:p-4" />
              <div className="mt-2">
